...
function FAQs() {
    ...
    <>
      ...
      <section className="w-full bg-white py-16 px-4 font-barlow">
        <div className="max-w-6xl mx-auto text-center">
          ...
          {/* PAGE HEADING */}
          <h1 className="text-3xl md:text-4xl font-barlow font-bold text-[#565656] mb-12">
            FAQ
          </h1>

          {/* ================= Campus & City Life ================= */}
          <div id="campus-life" className="bg-[#F2FEFF] rounded-lg px-10 py-6 text-left mb-8">
  ...
  1st yr BTech Civil Engg.
            ...
            <div className="mb-8 font-poppins">
              ...
              <p className=" text-xs italic text-[#565656] text-right">
  2nd yr BTech Maths and Computing
</p>
            </div>
  ...
  2nd yr BTech Textile Engg.
            ...
            <div className="mb-8">
              ...
              <p className=" text-xs italic text-[#565656] text-right">
   2nd yr BTech Applied Mechanics
</p>
            </div>
  ...
  3rd yr BTech Chemical Engg.
          ...
          <div id="research" className="bg-[#F2FEFF] rounded-lg px-10 py-6 text-left mb-8">
            <h2 className="text-xl font-bold font-barlow text-[#FB923C] text-center mb-10">
              Research & Academics Focus
            </h2>
  ...
  3rd yr BTech Chemical Engg.(dual)
          ...
          {/* ================= Miscellaneous / Fun ================= */}
          <div id="misc" className="bg-[#F2FEFF] rounded-lg px-10 py-6 text-left">
            <h2 className="text-xl font-bold font-barlow text-[#FB923C] text-center mb-10">
              Miscellaneous / Fun
            </h2>
